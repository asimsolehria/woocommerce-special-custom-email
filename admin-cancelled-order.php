                                                                                                                                            ...
                                                                                                                                            <tbody>
                                                                                                                                                <tr>
																																					...
																																					"
																																						...
																																						<?php // echo $order->get_billing_first_name(); ?><br>CANCELLED ORDER
                                                                                                                                                    </td>
                                                                                                                                                </tr>
                                                                                                                                                <tr>
                                                                                                                                                        ...
                                                                                                                                                        <table
                                                                                                                                                            ...
                                                                                                                                                            <tbody>
                                                                                                                                                                <tr>
                                                                                                                                                                    <td valign="middle"
                                                                                                                                                                        align="center">
                                                                                                                                                                        <img src="https://hive.gg/wp-content/uploads/2020/12/shopping-chart-grey.png"
                                                                                                                                                                            alt=""
                                                                                                                                                                            style="display:block"
                                                                                                                                                                            width="33">
                                                                                                                                                                    </td>
                                                                                                                                                ...
                                                                                                                                                <tr>
                                                                                                                                                    <td style="font-family:Geogrotesque,Arial,Verdana,Helvetica,sans-serif;color:#2f3132;font-size:16px;line-height:20px"
                                                                                                                                                        valign="top"
                                                                                                                                                        align="center">
                                                                                                                                                        Notification to let you know — order #<?php echo $order->get_id() ?> belonging to <?php echo $order->get_billing_first_name() ?> <?php echo $order->get_billing_last_name() ?> has been cancelled:
                                                                                                                                                    </td>
                                                                                                                                                </tr>
                                                                                                                                            </tbody>
                                                                                                                                        </table>
