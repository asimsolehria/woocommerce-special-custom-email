                                                                                                                                            ...
                                                                                                                                            <tbody>
                                                                                                                                                <tr>
																																					...
																																					"
																																						...
																																						<?php // echo $order->get_billing_first_name(); ?><br>FAILED ORDER
                                                                                                                                                    </td>
                                                                                                                                                </tr>
                                                                                                                                                <tr>
                                                                                                                                                ...
                                                                                                                                                <tr>
                                                                                                                                                    <td style="font-family:Geogrotesque,Arial,Verdana,Helvetica,sans-serif;color:#2f3132;font-size:16px;line-height:20px"
                                                                                                                                                        valign="top"
                                                                                                                                                        align="center">
                                                                                                                                                        Payment for order #<?php echo $order->get_id() ?> from <?php echo $order->get_billing_first_name() ?> <?php echo $order->get_billing_last_name() ?> has failed. The order was as follows:
                                                                                                                                                    </td>
                                                                                                                                                </tr>
                                                                                                                                            </tbody>
                                                                                                                                        </table>
