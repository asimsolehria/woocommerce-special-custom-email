                                                                                                                                            ...
                                                                                                                                            <tbody>
                                                                                                                                                <tr>
																																					...
																																					"
																																						...
																																						<?php echo $order->get_billing_first_name(); ?>,<br>YOUR ORDER IS REFUNDED
                                                                                                                                                    </td>
                                                                                                                                                </tr>
                                                                                                                                                <tr>
                                                                                                                                                ...
                                                                                                                                                <tr>
                                                                                                                                                    <td style="font-family:Geogrotesque,Arial,Verdana,Helvetica,sans-serif;color:#2f3132;font-size:16px;line-height:20px"
                                                                                                                                                        valign="top"
                                                                                                                                                        align="center">
                                                                                                                                                        Your order on <?php echo bloginfo('title') ?> has been refunded. There are more details below for your reference:
                                                                                                                                                    </td>
                                                                                                                                                </tr>
                                                                                                                                            </tbody>
                                                                                                                                        </table>
